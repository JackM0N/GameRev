...
--changeset Stanislaw:32 labels:expansion,schema
CREATE TABLE forum_request
(
    forum_request_id BIGINT PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
    forum_name       VARCHAR(100) NOT NULL,
    description      VARCHAR(100) NOT NULL,
    game_id          BIGINT REFERENCES game (game_id),
    parent_forum_id  BIGINT       NOT NULL REFERENCES forum (forum_id),
    author_id        BIGINT       NOT NULL REFERENCES website_user (user_id),
    approved         boolean
);
