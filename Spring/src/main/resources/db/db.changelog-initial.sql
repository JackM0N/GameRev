...
ALTER TABLE website_user ADD CONSTRAINT unique_nickname UNIQUE (nickname);
...
ALTER TABLE website_user ADD CONSTRAINT check_last_action_date CHECK (last_action_date <= CURRENT_TIMESTAMP);
